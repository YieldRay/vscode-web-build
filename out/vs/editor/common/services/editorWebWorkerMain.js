    ...
    const handler = {
      get: (target, name) => {
        if (typeof name === "string" && !target[name]) {
          ...
          } else if (name.charCodeAt(0) === 36 /* DollarSign */) {
        ...
        if (state === 13 /* Accept */) {
          ...
          switch (chCode) {
            ...
            case 96 /* BackTick */:
              ...
              } else if (linkBeginChCode === 39 /* SingleQuote */ || linkBeginChCode === 34 /* DoubleQuote */ || linkBeginChCode === 96 /* BackTick */) {
                chClass = 0 /* None */;
              } else {
                chClass = 1 /* ForceTermination */;
              }
...
var SCAN_CODE_STR_TO_EVENT_KEY_CODE = {};
...
((CompletionItemKinds2) => {
  ...
  byKind.set(28 /* Snippet */, Codicon.symbolSnippet);
  ...
  byKind.set(27 /* Tool */, Codicon.tools);
  ...
  function toLabel(kind) {
    switch (kind) {
      case 0 /* Method */:
        return localize(884, null);
      case 1 /* Function */:
        return localize(880, null);
      case 2 /* Constructor */:
        return localize(872, null);
      case 3 /* Field */:
        return localize(877, null);
      case 4 /* Variable */:
        return localize(897, null);
      case 5 /* Class */:
        return localize(869, null);
      case 6 /* Struct */:
        return localize(890, null);
      case 7 /* Interface */:
        return localize(881, null);
      case 8 /* Module */:
        return localize(885, null);
      case 9 /* Property */:
        return localize(887, null);
      case 10 /* Event */:
        return localize(876, null);
      case 11 /* Operator */:
        return localize(886, null);
      case 12 /* Unit */:
        return localize(894, null);
      case 13 /* Value */:
        return localize(896, null);
      case 14 /* Constant */:
      ...
      case 17 /* Keyword */:
        return localize(883, null);
      case 18 /* Text */:
        return localize(891, null);
      case 19 /* Color */:
        return localize(870, null);
      case 20 /* File */:
        return localize(878, null);
      case 21 /* Reference */:
        return localize(888, null);
      case 22 /* Customcolor */:
        return localize(873, null);
      case 23 /* Folder */:
        return localize(879, null);
      case 24 /* TypeParameter */:
        return localize(893, null);
      case 25 /* User */:
        return localize(895, null);
      case 26 /* Issue */:
        return localize(882, null);
      case 27 /* Tool */:
        return localize(892, null);
      case 28 /* Snippet */:
        return localize(889, null);
      default:
        return "";
    }
  }
...
var symbolKindNames = {
  [17 /* Array */]: localize(845, null),
  [16 /* Boolean */]: localize(846, null),
  [4 /* Class */]: localize(847, null),
  [13 /* Constant */]: localize(848, null),
  [8 /* Constructor */]: localize(849, null),
  [9 /* Enum */]: localize(850, null),
  [21 /* EnumMember */]: localize(851, null),
  [23 /* Event */]: localize(852, null),
  [7 /* Field */]: localize(853, null),
  [0 /* File */]: localize(854, null),
  [11 /* Function */]: localize(855, null),
  [10 /* Interface */]: localize(856, null),
  [19 /* Key */]: localize(857, null),
  [5 /* Method */]: localize(858, null),
  [1 /* Module */]: localize(859, null),
  [2 /* Namespace */]: localize(860, null),
  [20 /* Null */]: localize(861, null),
  [15 /* Number */]: localize(862, null),
  [18 /* Object */]: localize(863, null),
  [24 /* Operator */]: localize(864, null),
  [3 /* Package */]: localize(865, null),
  [6 /* Property */]: localize(866, null),
  [14 /* String */]: localize(867, null),
  [22 /* Struct */]: localize(868, null),
  [25 /* TypeParameter */]: localize(899, null),
  [12 /* Variable */]: localize(900, null)
};
var SymbolKinds;
((SymbolKinds2) => {
  const byKind = /* @__PURE__ */ new Map();
...
var KeyMod2 = class {
  static {
    this.CtrlCmd = 2048 /* CtrlCmd */;
  }
  static {
    this.Shift = 1024 /* Shift */;
  }
  static {
    this.Alt = 512 /* Alt */;
  }
  static {
    this.WinCtrl = 256 /* WinCtrl */;
  }
    ...
    switch (reason) {
      ...
      case 3 /* Ambiguous */: {
        ...
        const notAmbiguousInLocales = AmbiguousCharacters.getLocales().filter(
          (l) => !AmbiguousCharacters.getInstance(
...
function buildRegExpCharClassExpr(codePoints, flags) {
  const src = `[${escapeRegExpCharacters(
...
var CharSequence = class {
  ...
  toString() {
    return "[" + this._charCodes.map((s, idx) => (s === 10 /* LineFeed */ ? "\\n" : String.fromCharCode(s)) + `-(${this._lineNumbers[idx]},${this._columns[idx]})`).join(", ") + "]";
  }
  ...
  getEndLineNumber(i) {
    ...
    this._assertIndex(i, this._lineNumbers);
    if (this._charCodes[i] === 10 /* LineFeed */) {
...
// src/vs/editor/common/diff/externalLinesDiffComputer.ts
